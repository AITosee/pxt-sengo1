...
namespace tosee_sentry
{
    ...
    //%
    int sengo1_Begin(int mode, int addr, int baud, int user_seial)
    {
        ...
        return sengo1.begin((sentry_mode_e)mode, (uint8_t)addr);
    }
    ...
    //%
    int sengo1_CameraSetAwb(int awb)
    {
        return sengo1.CameraSetAwb((sentry_camera_white_balance_e)awb);
    }
